...
import { setNftAddress } from "../../../blockchain/actions/MLMarketplaceAction"
import { SettingsData } from "./SettingsData.types"
import {useModalContext} from "../../../hooks/ModalContext";
import {errorCatcher} from "../../../utils/helpers";

export default function MarketplaceContract() {
  // @ts-ignore
  ...
  const updateNftAddress = async () => {
    ...
    try {
      ...
      setLoading(true)
      setLocked(true)
      await setNftAddress(newNftAddress)
        .then(() => {
  ...
  return (
    <Container>
      <Header>ML Marketplace Address</Header>
      <Content>
        <Cell>
          <CellContent>
            <Row>
