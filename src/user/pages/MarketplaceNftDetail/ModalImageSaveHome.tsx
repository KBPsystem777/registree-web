...
export default function ModalImageSaveHome ({isOpen, closeModal}: Props) {
  ...
  useEffect(() => {
    if (isOpen) {
      $("#modal-image-savehome-container").fadeIn("fast")
    } else {
      $("#modal-image-savehome-container").fadeOut("fast")
    }
  ...
  return (
    <Container id="modal-image-savehome-container">
      <Base w={28} center={true} title="Login to wallet to save home" close={closeModal}>
        <Content>
