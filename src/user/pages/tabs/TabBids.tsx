...
import { getNftBids } from "../../../api/Nft";
...
let w = 14, h = 18;
export default function TabBids() {
    ...
    function handleShowDetailClick(item: any) {
        console.log(item)
        navigate(`/marketplace/${item?.token_address || ADDRESS}/${item?.token_id || item?.tokenId}`)
    }
